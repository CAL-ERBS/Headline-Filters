...
container.AddBlock( customcontent );
	...
	customcontent.contents=customcontent.contents.replace("__SCREENTITLE__","Your Stats (Today). Last Run "+padDate(_lastrun.getHours())+":"+padDate(_lastrun.getMinutes())+"&nbsp;<a href=\"#\" onclick=\"location.reload(); return false;\">Reload</a>");
