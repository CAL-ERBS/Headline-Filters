...
QmulusOrderBlock.Title = 'Requesting Order '+OrderRecord.orde_reference+' to Sage Accounts to the Value of '+CurrencyRecord.curr_symbol+'  '+parseFloat(OrderRecord.orde_grossamt).toFixed(2)+'';
...
if ((Q50FRecord.qnfi_onhold) != 'Y') 
{
QmulusContentBlock.contents = '<a class="er_buttonItem" onclick="SageCRM.utilities.appendOverlay();" href="RequestedOrder.asp?SID='+SID+'&Key71='+OrderID+'" id="Button_QuickPostOrder">Confirm & Request Order</a>';
}
...
var strScript = "javascript: x = window.open('" + qnectHelpLocation + "/Default_CSH.htm#Order/Request-Order-To-Accounts.htm?PopupWin=Y','WebPickerNew','scrollbars=yes,toolbar=no,menubar=no,resizable=yes,top=100, width=800,height=600'); void (x)";
