...
QmulusQuoteBlock.Title = 'Posting Quote '+QuoteRecord.quot_reference+' to Sage 200 Accounts to the Value of '+CurrencyRecord.curr_symbol+'  '+parseFloat(QuoteRecord.quot_grossamt).toFixed(2)+'';
...
//if ((Q50FRecord.qnfi_onhold) != 'Y') 
{
QmulusContentBlock.contents = '<a class="er_buttonItem" onclick="SageCRM.utilities.appendOverlay();" href="PostedQuote.asp?SID='+SID+'&Key86='+QuoteID+'" id="Button_QuickPostQuote">Confirm & Post Quote</a>';
}
...
var strScript = "javascript: x = window.open('" + qnectHelpLocation + "/Default_CSH.htm#Quote/Post-Quote-To-Accounts.htm?PopupWin=Y','WebPickerNew','scrollbars=yes,toolbar=no,menubar=no,resizable=yes,top=100, width=800,height=600'); void (x)";
